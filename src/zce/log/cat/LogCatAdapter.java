 ...
 * view you want.
 */
public class LogCatAdapter<T> extends BaseAdapter implements Filterable {
	/**
	 * Contains the list of objects that represent the data of this
	 * LogCatAdapter. The content of this list is referred to as "the array" in
	 * the documentation.
	 */
	 ...
	 */
	public LogCatAdapter(Context context, int textViewResourceId) {
	 ...
	 *            populated
	 */
	public LogCatAdapter(Context context, int resource, int textViewResourceId) {
	 ...
	 */
	public LogCatAdapter(Context context, int textViewResourceId, T[] objects) {
	...
	private View createViewFromResource(int position, View convertView,
		...
		try {
			...
			throw new IllegalStateException(
					"LogCatAdapter requires the resource ID to be a TextView",
					e);
		}
	...
	/**
	 * Creates a new LogCatAdapter from external resources. The content of the
	 ...
	 * 
	 * @return An LogCatAdapter<CharSequence>.
	 */
	public static LogCatAdapter<CharSequence> createFromResource(
			Context context, int textArrayResId, int textViewResId) {
		CharSequence[] strings = context.getResources().getTextArray(
				textArrayResId);
		return new LogCatAdapter<CharSequence>(context, textViewResId, strings);
	}
